...
// let hamburger_toggle_active = $('.hamburger-navbar-icon-toggler')
// function mediaScreenSize() {
//     if(window.matchMedia('(min-width: 768px)').matches) {
//         hamburger_toggle_active.click()
//     }
// }
// mediaScreenSize()
// window.addEventListener('resize', mediaScreenSize, false)
...
// const mobileMenu = document.querySelector('#mobile_navbar_list')
// navBTN = true 
...
//         navButton.classList.add('is-close');
//         navBTN = true;
//     }
// }
...
//         $('header').removeClass('md:relative')
//     } else {
