...
<label for="{{ $for }}" id="{{ $tag }}" class="flex items-end space-x-4 absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-white dark:text-dark-600 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-minsk-900 dark:peer-focus:text-white">
